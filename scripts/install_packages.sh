...
graphviz plasma-browser-integration firejail dbeaver wine strace qt5-tools"
...
PACKAGES_AUR="buddhasay gcsfuse google-cloud-sdk tunnelbear google-chrome gitkraken btrbk \
